        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mt-4">
                            ...
                            <div class="fs-4 mt-4">
                                <!--Facebook-->
                                <a href="https://www.facebook.com/profile.php?id=100071521481050" class=" me-2">
                                ...
                                <!--GitHub-->
                                <a href="https://www.instagram.com/gkimojokerto/" class="">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                ...
                <div class="offset-lg-1 col-lg-2 col-md-3 col-6">
                    <div class="mb-4">
                        ...
                        <ul class="list-unstyled nav nav-footer flex-column nav-x-0">
                            <li><a href="/homepage" class="nav-footers">Home</a></li>
              ...
              <div class="mb-4">
                ...
                <ul class="list-unstyled nav nav-footer flex-column nav-x-0">
                  <li><a href="#" class="nav-footers">Sermons</a></li>
